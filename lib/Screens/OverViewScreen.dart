                        ...
                        children: <Widget>[
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                BoldText("Emperor Resorts", 20.0, kblack),
                                Row(
                                  children: <Widget>[
                                ...
                                NormalText(
                                    "₹3956 + ₹427 taxes & fees", kgreyDark, 16.0),
                                SizedBox(
                                  height: 10.0,
                                ),
                                Container(
                                ...
                                NormalText(
                                    " Emperor Resorts & Spa is a great choice for travellers looking for a 5 star hotel in Goa. It is located in Vagator. Hotel is rated 4.5 out of 5, which is considered as Very good. ",
                                    kblack, 12.0),
                                SizedBox(
                                  height: 10.0,
                                ),
  ...
  Widget reviewProfile(String name,String review,String date) {
    return Column(
      ...
      children: <Widget>[
        ...
        SizedBox(height: 10,),
        NormalText("Very good servies & hotel",kblack,12.0),
        SizedBox(height: 10,),
      ],
    );
  }
