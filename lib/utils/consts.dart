...
final kgreyFill =  Colors.grey.shade100;
 ...
 const String SLIDER_HEADING_1 = "Easy to Use!";
 const String SLIDER_HEADING_2 = "Explore!";
 const String SLIDER_HEADING_3 = "Create Memories";
 const String SLIDER_DESC = "An easy travel book before planning the trip";